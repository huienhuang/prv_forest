...
product_tabs['Combinations'] = new function(){
		...
		function editProductAttribute (url, parent){
			$.ajax({
				...
				success: function(data) {
					...
					var short_desc = data[0]['short_desc'];
	...
	ean, quantity, image, old_attr, id_product_attribute, default_attribute, eco_tax, upc, minimal_quantity, available_date, short_desc)
	{
		var link = '';
		self.init_elems();
		...
		getE('attribute_short_desc').value = short_desc;
